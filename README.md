...
Vector embeddings can be created by just clicking on the data to be uploaded via the Streamlit front end, and then clicking on <ins>**'Process and Upload to Pinecone'**</ins> button. The back end at main.py will efficiently handle data chunking and all other Pinecone embedding processes. 
